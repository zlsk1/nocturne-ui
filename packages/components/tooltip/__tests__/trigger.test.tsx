...
import NTooltipTrigger from '../src/trigger.vue'
...
describe('NTooltipTrigger', () => {
  ...
  const createComponent = (props = {}) =>
    mount(
      {
        setup() {
          return () => <NTooltipTrigger {...props}>{AXIOM}</NTooltipTrigger>
        }
      },
      {
        global: {
          provide: defaultProvide,
          stubs: ['NPopperTrigger']
        },
  ...
  describe('trigger event', () => {
    describe('controlled', () => {
      it('should not trigger anything when tooltip is controlled', async () => {
        ...
        const { vm } = wrapper.findComponent(NTooltipTrigger) as VueWrapper<any>
