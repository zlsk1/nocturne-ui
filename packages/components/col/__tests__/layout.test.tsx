...
import Row from '@nocturne-ui/components/row'
import Col from '../src/col.vue'

describe('Col', () => {
  test('create', () => {
    const wrapper = mount(() => <Col />)
    expect(wrapper.classes()).toContain('n-col')
  })

  test('span', () => {
    const wrapper = mount(() => <Col span={12} />)
    expect(wrapper.classes()).toContain('n-col-12')
  })

  test('pull', () => {
    const wrapper = mount(() => <Col span={12} pull={3} />)
    expect(wrapper.classes()).toContain('n-col-pull-3')
  })

  test('push', () => {
    const wrapper = mount(() => <Col span={12} push={3} />)
    expect(wrapper.classes()).toContain('n-col-push-3')
  })
  ...
  test('responsive', () => {
    ...
    expect(colElmClass.includes('n-col-sm-4')).toBe(true)
    expect(colElmClass.includes('n-col-sm-4')).toBe(true)
    expect(colElmClass.includes('n-col-sm-offset-2')).toBe(true)
    expect(colElmClass.includes('n-col-lg-6')).toBe(true)
    expect(colElmClass.includes('n-col-lg-offset-3')).toBe(true)
    expect(colElmClass.includes('n-col-md-8')).toBe(true)
  })
})
...
describe('Row', () => {
  test('create', () => {
    ...
    expect(wrapper.classes()).toContain('n-row')
  })
